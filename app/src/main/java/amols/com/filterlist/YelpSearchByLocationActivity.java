...
public class YelpSearchByLocationActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener
    {
    ...
    public void onLocationChanged(android.location.Location location)
    {
        if(location != null)
        {
           ...
           ((TextView) findViewById(R.id.txt_lng)).setText("" + location.getLongitude());
            ...
            {
                Intent myIntent = new Intent(YelpSearchByLocationActivity.this, YelpSearchNearbyActivity.class);
